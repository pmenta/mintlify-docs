...
- `reference_type`: Esse parâmetro define o tipo de entidade que você quer monitorar 'cpf', 'cnpj', 'oab' ou 'lawsuit_cnj' para o número do processo.
...
`reference_type`: retorna monitoramentos do tipo de referência especificado 'cpf', 'cnpj', 'oab' ou 'lawsuit_cnj' número do processo;
